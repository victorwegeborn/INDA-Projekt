...
public class FireRayCastHandler implements RayCastCallback {
	...
	public float reportRayFixture(Fixture fixture, Vector2 point,
		...
		GameRefactor.DrawSquare(point.x, point.y, Color.RED);
		...
		if(fixtureCategory == B2DVars.BIT_BOX){
			...
			if(i < B2DVars.DROP_RATE){
					...
					GameRefactor.PlacePowerUp(B2DVars.BOMB_POWERUP, fixture.getBody().getPosition());
					}
					
					if(i >= B2DVars.DROP_RATE / 2){
					GameRefactor.PlacePowerUp(B2DVars.FIRE_POWERUP, fixture.getBody().getPosition());
					}
				}
		}
