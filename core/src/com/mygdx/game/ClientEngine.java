...
public class ClientEngine implements Screen {
	...
	public void UpdatePlayers(PlayerUpdate activePlayers){
		this.activePlayers = activePlayers;
	}
	
	public void UpdateBombs(BombUpdate activeBombs){
		this.activeBombs = activeBombs;
	}
	
	public void UpdateFires(FireUpdate activeFires){
		this.activeFires = activeFires;
	}
	
	public void UpdateItems(ItemUpdate activeItems){
		this.activeItems = activeItems;
	}
	
	public void SetShakeFactor(float f){
		shake.shake(f);
	}
